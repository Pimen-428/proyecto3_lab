...
Partial Class voluntarios_pag_añadir
    ...
    Private Sub InitializeComponent()
        ...
        ' 
        TextBoxNombre_añadir.Location = New Point(434, 139)
        ...
        ' ComboBox_añadir
        ' 
        ComboBox_añadir.DropDownStyle = ComboBoxStyle.DropDownList
        ...
        ' TextBoxDni_añadir
        ' 
        TextBoxDni_añadir.Location = New Point(215, 139)
        ...
        centro_label.Location = New Point(434, 205)
        ...
        especialidad_label.Location = New Point(215, 205)
